...
def getcard(message):
    ...
    if choosen_directory == monke_memes:
        card_path = (
            r'C:\Users\User\PycharmProjects\git_project\bot\monke_images\{}\{}'.format(monke_memes,
                                                                                       directory_monke_memes[
                                                                                           random.randint(
                                                                                               0,
        ...
        card_path = (
            r'C:\Users\User\PycharmProjects\git_project\bot\monke_images\{}\{}'.format(monke_nfts,
                                                                                       directory_monke_nfts[
                                                                                           random.randint(
                                                                                               0,
